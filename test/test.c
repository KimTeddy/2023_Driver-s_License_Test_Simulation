...
void *AccelWork(void)
{
    ...
    {         // 나중에 1 대신 트리거 변수로 바꾸기.
              //  if((reverseframe==1)&&(rev==0)) { if(gear==2) gear=1; else if (gear==1) gear=2; rev=1;}
              // if((reverseframe==0) && (rev==1)) rev=0;
        ...
        else if (gear == 1 && ((first_accel[0] - second_accel[0]) > 5000) && !(((first_accel[2] - second_accel[2]) < 9000) && ((first_accel[2] - second_accel[2]) > 4000)))
...
void *ScreenOverlay(void)
{
    ...
    while (1)
    {
        ...
        case 3:
        {
            ...
            {
            case 0:
                strcpy(overlayname, "empty");
                break;
            case 1:
                strcpy(overlayname, "safetybeltfail");
                break;
            case 2:
                strcpy(overlayname, "start1");
                break;
            case 3:
                strcpy(overlayname, "start2");
                break;
            case 4:
                strcpy(overlayname, "start3");
                break;
            case 5:
                strcpy(overlayname, "startfail");
                break;
            case 6:
                strcpy(overlayname, "startsucceess");
                break;
            case 7:
                strcpy(overlayname, "basicgeardrive");
                break;
            case 8:
                strcpy(overlayname, "basicgeardrivefail");
                break;
            case 9:
                strcpy(overlayname, "basicgeardrivesuccess");
                break;
            case 10:
                strcpy(overlayname, "basicgearrev");
                break;
            case 11:
                strcpy(overlayname, "basicgearrevfail");
                break;
            case 12:
                strcpy(overlayname, "basicgearrevsuccess");
                break;
            case 13:
                strcpy(overlayname, "basicwiper");
                break;
            case 14:
                strcpy(overlayname, "basicwiperfail");
                break;
            case 15:
                strcpy(overlayname, "basicwipersuccess");
                break;
            case 16:
                strcpy(overlayname, "basiclightup");
                break;
            case 17:
                strcpy(overlayname, "basiclightupfail");
                break;
            case 18:
                strcpy(overlayname, "basiclightupsucces");
                break;
            case 19:
                strcpy(overlayname, "basiclightdown");
                break;
            case 20:
                strcpy(overlayname, "basiclightdownfail");
                break;
            case 21:
                strcpy(overlayname, "basiclightdownsuccess");
                break;
            case 22:
                strcpy(overlayname, "basiclightleft");
                break;
            case 23:
                strcpy(overlayname, "basiclightleftfail");
                break;
            case 24:
                strcpy(overlayname, "basiclightleftsuccess");
                break;
            case 25:
                strcpy(overlayname, "basiclightright");
                break;
            case 26:
                strcpy(overlayname, "basiclightrightfail");
                break;
            case 27:
                strcpy(overlayname, "basiclightrightsuccess");
                break;
            case 28:
                strcpy(overlayname, "basicfin");
                break;
            case 29:
                strcpy(overlayname, "basicfinfail");
                break;
            case 30:
                strcpy(overlayname, "emer");
                break;
            case 31:
                strcpy(overlayname, "emerfail");
                break;
            case 32:
                strcpy(overlayname, "uphill");
                break;
            case 33:
                strcpy(overlayname, "uphill2");
                break;
            case 34:
                strcpy(overlayname, "uphillfail");
                break;
            case 35:
                strcpy(overlayname, "crash");
                break;
            case 36:
                strcpy(overlayname, "parking");
                break;
            case 37:
                strcpy(overlayname, "parkingfail");
                break;
            case 38:
                strcpy(overlayname, "accel");
                break;
            case 39:
                strcpy(overlayname, "accelfail");
                break;
            case 40:
                strcpy(overlayname, "accelstopfail");
                break;
            case 41:
                strcpy(overlayname, "junction");
                break;
            case 42:
                strcpy(overlayname, "junctiontimefail");
                break;
            case 43:
                strcpy(overlayname, "junctioncrash");
                break;
            case 44:
                strcpy(overlayname, "endlightfail");
                break;
            case 45:
                strcpy(overlayname, "testfail");
                break;
            case 46:
                strcpy(overlayname, "testout");
                break;
            case 47:
                strcpy(overlayname, "testsuccess");
                break;
            case 48:
                strcpy(overlayname, "testfin");
                break;
            case 49:
                strcpy(overlayname, "overlaybutton");
                break;
            case 50:
                strcpy(overlayname, "overlaylight");
                break;
            case 51:
                strcpy(overlayname, "overlaywiper0");
                break;
            case 52:
                strcpy(overlayname, "overlaywiper1");
                break;
            case 53:
                strcpy(overlayname, "overlaywiper2");
                break;
            default:
                break;
            }
...
{ // 시험 코스 진행할 것 작성   while문으로 구간 판별후 반복조건문 탈출하게 작성해야함.
    ...
    if (next == 1)
    {
        ...
        while (1)
        {
            if (nums <= 17 && nums <= 20 && leftlight == 1)
                leftlightpass = 1;
        ...
        while (1)
        {
            ...
            while (nums <= 410)
            {
                ...
                while (1)
                {
                    ...
                    usleep(500000);
                    if (nums <= 482 && nums >= 479 && sidebrake)
                    {
                        buzzerPlaySong(740);
                        sleep(1);
                        buzzerStopSong();
           ...
           gameoverlaycheck=54;
               ...
               return 1;
                ...
                while (1)
                {
                    ...
                    if (nums <= 745 && nums >= 729 && leftlight == 1)
                        junctionpass = 1;
            ...
            while (1)
            {
                ...
                else if ((nums <= 1080 && nums >= 1025) & (!rightlight))
                    finalsuccess = 0;
                if (nums >= 1060)
                    break;
            }
